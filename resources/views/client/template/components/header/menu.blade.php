                ...
                <div class="main-menu main-menu-padding-1 main-menu-lh-2 d-none d-lg-block">
                    <nav>
                        <ul>
                            ...
                            <li><a href="{{  route('category.show', ['category' => 'Cajas de Linea']) }}">Categorias <i
                                            class="fi-rs-angle-down"></i></a>
                                <ul class="sub-menu">
                                    <li><a href="#">Cajas<i class="fi-rs-angle-right"></i></a>
                                        <ul class="level-menu">
                                            <li>
                                                <a href="{{  route('category.show', ['category' => 'Cajas de Linea']) }}">Cajas
                                                    de linea</a></li>
                                            <li>
                                                <a href="{{  route('category.show', ['category' => 'Cajas Delivery']) }}">Cajas
                                                    delivery</a></li>
                                            <li>
                                                <a href="{{  route('category.show', ['category' => 'Cajas de Plastico']) }}">Cajas
                                                    de plastico</a></li>
                                        </ul>
                                    </li>
                                    <li><a href="{{  route('category.show', ['category' => 'Carton Corrugado']) }}">Cartón
                                            corrugado</a></li>
                                    <li>
                                        <a href="{{  route('category.show', ['category' => 'Esquineros']) }}">Esquineros</a>
                                    </li>
                                    ...
                                    <li><a href="{{  route('category.show', ['category' => 'Papel Kraft']) }}">Papel
                                            Kraft</a></li>
                                    <li>
                                        <a href="{{  route('category.show', ['category' => 'Cacahuate']) }}">Cacahuate</a>
                                    </li>
                                    <li><a href="{{  route('category.show', ['category' => 'Aire Sellado']) }}">Aire
                                            Sellado</a></li>
                                    <li>
                                        <a href="{{  route('category.show', ['category' => 'Archiveros']) }}">Archiveros</a>
                                    </li>
                                    <li><a href="{{  route('category.show', ['category' => 'Hogar']) }}">Hogar</a></li>
                                    <li><a href="{{  route('category.show', ['category' => 'Oficina']) }}">Oficina</a>
                                    </li>
                                    ...
                                    <li><a href="{{  route('category.show', ['category' => 'Papel Engomado']) }}">Pepel
                                            Engomado</a></li>
                                    <li>
                                        <a href="{{  route('category.show', ['category' => 'Espuma de Polietileno']) }}">Espuma
                                            de polietileno</a></li>
                                    ...
                                    <li><a href="{{  route('category.show', ['category' => 'Hojas de cartón']) }}">Hojas
                                            de cartón</a></li>
                                    <li>
                                        <a href="{{  route('category.show', ['category' => 'Papeleria']) }}">Papeleria</a>
                                    </li>
