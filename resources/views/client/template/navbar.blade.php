                    ...
                    <div class="col-md-6 col-sm-12 col-xs-12">
                        <div class="detail-gallery">
                            ...
                            <div class="product-image-slider">
                                <figure class="border-radius-10">
                                    <img src="assets/client/imgs/shop/product-16-2.jpg" alt="product image">
                                </figure>
                                <figure class="border-radius-10">
                                    <img src="assets/client/imgs/shop/product-16-1.jpg" alt="product image">
                                </figure>
                                <figure class="border-radius-10">
                                    <img src="assets/client/imgs/shop/product-16-3.jpg" alt="product image">
                                </figure>
                                <figure class="border-radius-10">
                                    <img src="assets/client/imgs/shop/product-16-4.jpg" alt="product image">
                                </figure>
                                <figure class="border-radius-10">
                                    <img src="assets/client/imgs/shop/product-16-5.jpg" alt="product image">
                                </figure>
                                <figure class="border-radius-10">
                                    <img src="assets/client/imgs/shop/product-16-6.jpg" alt="product image">
                                </figure>
                                <figure class="border-radius-10">
                                    <img src="assets/client/imgs/shop/product-16-7.jpg" alt="product image">
                                </figure>
                            </div>
                            <!-- THUMBNAILS -->
                            <div class="slider-nav-thumbnails pl-15 pr-15">
                                <div><img src="assets/client/imgs/shop/thumbnail-3.jpg" alt="product image"></div>
                                <div><img src="assets/client/imgs/shop/thumbnail-4.jpg" alt="product image"></div>
                                <div><img src="assets/client/imgs/shop/thumbnail-5.jpg" alt="product image"></div>
                                <div><img src="assets/client/imgs/shop/thumbnail-6.jpg" alt="product image"></div>
                                <div><img src="assets/client/imgs/shop/thumbnail-7.jpg" alt="product image"></div>
                                <div><img src="assets/client/imgs/shop/thumbnail-8.jpg" alt="product image"></div>
                                <div><img src="assets/client/imgs/shop/thumbnail-9.jpg" alt="product image"></div>
                            </div>
                        </div>
                        <!-- End Gallery -->
                        <div class="social-icons single-share">
                            <ul class="text-grey-5 d-inline-block">
                                ...
                                <li class="social-facebook"><a href="#"><img src="assets/client/imgs/theme/icons/icon-facebook.svg" alt=""></a></li>
                                <li class="social-twitter"> <a href="#"><img src="assets/client/imgs/theme/icons/icon-twitter.svg" alt=""></a></li>
                                <li class="social-instagram"><a href="#"><img src="assets/client/imgs/theme/icons/icon-instagram.svg" alt=""></a></li>
                                <li class="social-linkedin"><a href="#"><img src="assets/client/imgs/theme/icons/icon-pinterest.svg" alt=""></a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-12 col-xs-12">
                        ...
                        <ul>
                            <li>
                                ...
                                <ul class="language-dropdown">
                                    <li><a href="#"><img src="assets/client/imgs/theme/flag-fr.png" alt="">Français</a></li>
                                    <li><a href="#"><img src="assets/client/imgs/theme/flag-dt.png" alt="">Deutsch</a></li>
                                    <li><a href="#"><img src="assets/client/imgs/theme/flag-ru.png" alt="">Pусский</a></li>
                                </ul>
                            </li>
        ...
        <div class="container">
            <div class="header-wrap">
                <div class="logo logo-width-1">
                    <a href="index.html"><img src="{{asset('assets/client/imgs/theme/logo.png')}}" alt="logo"></a>
                </div>
                        ...
                        <div class="header-action-2">
                            <div class="header-action-icon-2">
                                <a href="shop-wishlist.html">
                                    <img class="svgInject" alt="Evara" src="assets/client/imgs/theme/icons/icon-heart.svg">
                                    <span class="pro-count blue">4</span>
                                </a>
                            </div>
                            <div class="header-action-icon-2">
                                <a class="mini-cart-icon" href="shop-cart.html">
                                    <img alt="Evara" src="assets/client/imgs/theme/icons/icon-cart.svg">
                                    ...
                                    <ul>
                                        <li>
                                            <div class="shopping-cart-img">
                                                <a href="shop-product-right.html"><img alt="Evara" src="assets/client/imgs/shop/thumbnail-3.jpg"></a>
                                            </div>
                                        ...
                                        <li>
                                            <div class="shopping-cart-img">
                                                <a href="shop-product-right.html"><img alt="Evara" src="assets/client/imgs/shop/thumbnail-2.jpg"></a>
                                            </div>
                                            <div class="shopping-cart-title">
            ...
            <div class="header-wrap header-space-between position-relative  main-nav">
                                        ...
                                        <ul class="mega-menu d-lg-flex">
                                            ...
                                            <li class="mega-menu-col col-lg-5">
                                                <div class="header-banner2">
                                                    <img src="assets/client/imgs/banner/menu-banner-2.jpg" alt="menu_banner1">
                                                ...
                                                <div class="header-banner2">
                                                    <img src="assets/client/imgs/banner/menu-banner-3.jpg" alt="menu_banner2">
                                                    <div class="banne_info">
                                                        <h6>15% Off</h6>
                                                        <h4>Hot Deals</h4>
                                                        <a href="#">Shop now</a>
                                ...
                                <li class="has-children">
                                    ...
                                    <div class="dropdown-menu">
                                        <ul class="mega-menu d-lg-flex">
                                            ...
                                            <li class="mega-menu-col col-lg-5">
                                                <div class="header-banner2">
                                                    <img src="assets/client/imgs/banner/menu-banner-4.jpg" alt="menu_banner1">
                                                    <div class="banne_info">
                                                        <h6>10% Off</h6>
                                                        <h4>New Arrival</h4>
                                                        <a href="#">Shop now</a>
                                ...
                                <li class="has-children">
                                    ...
                                    <div class="dropdown-menu">
                                        <ul class="mega-menu d-lg-flex">
                                            ...
                                            <li class="mega-menu-col col-lg-5">
                                                <div class="header-banner2">
                                                    <img src="assets/client/imgs/banner/menu-banner-5.jpg" alt="menu_banner1">
                                                    <div class="banne_info">
                                                        <h6>10% Off</h6>
                                                        <h4>New Arrival</h4>
                                                        <a href="#">Shop now</a>
                                                ...
                                                <div class="header-banner2">
                                                    <img src="assets/client/imgs/banner/menu-banner-6.jpg" alt="menu_banner2">
                                                    <div class="banne_info">
                                                        <h6>15% Off</h6>
                                                        <h4>Hot Deals</h4>
                                                        <a href="#">Shop now</a>
                                    ...
                                    <ul class="mega-menu">
                                        ...
                                        <li class="sub-mega-menu sub-mega-menu-width-34">
                                            <div class="menu-banner-wrap">
                                                <a href="shop-product-right.html"><img src="assets/client/imgs/banner/menu-banner.jpg" alt="Evara"></a>
                ...
                <div class="header-action-right d-block d-lg-none">
                    <div class="header-action-2">
                        <div class="header-action-icon-2">
                            <a href="shop-wishlist.html">
                                <img alt="Evara" src="assets/client/imgs/theme/icons/icon-heart.svg">
                        ...
                        <div class="header-action-icon-2">
                            ...
                            <div class="cart-dropdown-wrap cart-dropdown-hm2">
                                <ul>
                                    ...
                                    <li>
                                        <div class="shopping-cart-img">
                                            <a href="shop-product-right.html"><img alt="Evara" src="assets/client/imgs/shop/thumbnail-4.jpg"></a>
                                        </div>
                                        <div class="shopping-cart-title">
    ...
    <div class="mobile-header-wrapper-inner">
        ...
        <div class="mobile-header-content-area">
            ...
            <div class="mobile-social-icon">
                ...
                <a href="#"><img src="assets/client/imgs/theme/icons/icon-facebook.svg" alt=""></a>
                <a href="#"><img src="assets/client/imgs/theme/icons/icon-twitter.svg" alt=""></a>
                <a href="#"><img src="assets/client/imgs/theme/icons/icon-instagram.svg" alt=""></a>
